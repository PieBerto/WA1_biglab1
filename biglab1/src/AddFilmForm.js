...
import {BrowserRouter, Routes, Route, Outlet, Link,NavLink, useNavigate, useParams, useHistory} from 'react-router-dom'
        ...
        <Container fluid>
            ...
            <Form>
                ...
                <div align='right'>
                    ...
                    {' '}
                    <Button  type='submit' variant='outline-success' onClick = {props.mode ? (event) => onSubmitUpdate(event):(event) => onSubmit(event)}>{props.mode? 'Save' : 'Add'}</Button>
                </div>
                </Row>
            </Form>
        </Container> 
